...
export const metadata: Metadata = {
  ...
  description: "Connect DHL Express to ITD for global express shipping, automated customs, and real-time international tracking.",
};
...
export default function DhlPage() {
  return (
    <CarrierPage
      ...
      tagline="The world's leading international express carrier, fully integrated with ITD."
      description="DHL Express connects you to 220+ countries with time-definite international delivery. Through ITD, you get automated customs documentation, real-time global tracking, and intelligent rate comparison across all DHL services — from Express Worldwide to Economy Select."
      ...
      features={[
        ...
        { icon: Eye, title: "Global tracking", desc: "Real-time tracking across 220+ countries in your ITD dashboard with exception alerts." },
