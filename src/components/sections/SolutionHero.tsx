...
export default function SolutionHero({
  ...
  return (
    <section className="bleed-nav relative overflow-hidden min-h-[640px] md:min-h-[700px] lg:min-h-[760px] bg-bg-dark">
      {/* Background layers — extended up over the floating-nav strip so the
          photo (not the fallback colour) shows through the nav's gutter. */}
      <div className="absolute inset-x-0 bottom-0 top-[calc(-1*var(--nav-h))]">
